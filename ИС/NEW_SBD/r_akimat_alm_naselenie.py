...
def get_source_conn() -> any:
    ...
    """
    try:
        conn_secrets = Connection.get_connection_from_secrets(conn_id="AIS_NASELENIE")
        return mysql.connector.connect(database=conn_secrets.schema, user=conn_secrets.login, password=conn_secrets.password, host=conn_secrets.host, port=conn_secrets.port)
...
def get_dag_configs(key):
    configs = {
        'dag_id': "r_akimat_alm_naselenie",
        'owner': "Bakhtiyar",
        'start_date': datetime.datetime.strptime('28/07/2023', '%d/%m/%Y'),
        'schedule_interval': "0 0 * * *",
        'tags': ['mysql', 'naselenie', 'reglament'],
    }
...
#   Reglament update, truncate load case
    ...
    METADATA = [
        {
            "source_schema": "PASPORT1",
            "target_schema": "R_AKIMAT_ALM_NASELENIE",
            "tables": [
                {
                    "source_table": "ADAM",
                    "hash_column_indexes": [
                ...
                {
                    "source_table": "S_COMPANY",
                    "hash_column_indexes": [],
                    "n_columns": 8,
                    "sql": None
                },
                {
                    "source_table": "S_COUNTRIES",
                    "hash_column_indexes": [],
                    "n_columns": 10,
                    "sql": None
                },
                ...
                {
                    "source_table": "S_NSPNKT",
                    "hash_column_indexes": [],
                    "n_columns": 9,
                    "sql": None
                },
                {
                    "source_table": "S_OPERAC",
                    "hash_column_indexes": [],
                    "n_columns": 10,
                    "sql": None
                },
                ...
                {
                    "source_table": "S_STATES",
                    "hash_column_indexes": [],
                    "n_columns": 10,
                    "sql": None
                },
                {
                    "source_table": "S_STATUS",
                    "hash_column_indexes": [],
                    "n_columns": 7,
                    "sql": None
                },
                {
                    "source_table": "S_TYPE_APARTMENT",
                    "hash_column_indexes": [],
                    "n_columns": 8,
                    "sql": None
                },
                {
                    "source_table": "S_TYPE_DECLARATION",
                    "hash_column_indexes": [],
                    "n_columns": 7,
                    "sql": None
                },
                {
                    "source_table": "S_TYPE_REGISTRATION",
                    "hash_column_indexes": [],
                    "n_columns": 6,
                    "sql": None
                },
