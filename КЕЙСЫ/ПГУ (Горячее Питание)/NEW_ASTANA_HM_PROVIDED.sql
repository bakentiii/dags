  ...
  and SAA.ID IN (
    ...
    WHERE SST.CODE LIKE '02.1.%'
       ...
       OR SST.CODE IN ('02.6.1', '02.6.2', '02.6.3', '02.6.4')) --and s.id=19602
         ...
         AND sf.SDD <= 40567 and sf.SDD != 0 and sf.SDD is not null
  group by s.ID, s.RU_NAME,s.KK_NAME,AREA.RNAME, REGION.RNAME, LOCALITY.RNAME,e2.IS_ORPHAN,e2.CLASS_NUM_ID,efp.HOTMEAL_PROVIDE_ID,s2.ID,s2.IIN,e2.ID,sf.INCOME_ASP,sf.SDD,SK_FAMILY_ID 
